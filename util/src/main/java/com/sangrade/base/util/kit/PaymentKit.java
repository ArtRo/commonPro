package com.sangrade.base.util.kit;

import com.sangrade.base.util.util.Charsets;
import com.sangrade.base.util.util.XmlHelper;
 ...
 * 微信支付的统一下单工具类
 */
public class PaymentKit  implements Serializable {
	 ...
	 * @return <Map<String, String>>
	 */
	public static Map<String, String> prepayIdCreateSign(String prepay_id,String appId,String apiKey) {
		...
		String packageSign = PaymentKit.createSign(packageParams, apiKey);
